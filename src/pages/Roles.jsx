...
import Assign from "../components/Roles/Assign";
    ...
    <div className="flex">
      ...
      {isConfirmed && (
        <Assign
          ...
          setSearchEmployeeQuery={setSearchEmployeeQuery}
          searchRoleQuery={searchRoleQuery}
          setSearchRoleQuery={setSearchRoleQuery}
          filteredEmployeeResults={filteredEmployeeResults}
          filteredRolesSelected={filteredRolesSelected}
          handleSelect={handleSelect}
          roleSelected={roleSelected}
          handleRolesSelected={handleRolesSelected}
        />
      )}
    </div>
  );
